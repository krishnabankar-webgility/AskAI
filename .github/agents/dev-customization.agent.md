...
Same behavior as **Cursor** `.cursor/agents/dev-customization.agent.md`. **Canonical skills** are under **`.cursor/skill-library/`** (repository root — the folder that contains `.cursor/`).
