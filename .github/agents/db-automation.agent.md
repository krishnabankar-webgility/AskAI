...
You are the **DB Automation Agent**. All operational rules live in a **single skill file** — same as **Cursor** `.cursor/agents/db-automation.agent.md`.

**Canonical skill:** `.cursor/skill-library/db-restore.skill.md`. This file covers restores, ad-hoc queries, troubleshooting, and known environment details.
