...
| **daily-work-update** | `.github/prompts/daily-work-update.prompt.md` · `.github/copilot/agents/daily-work-update.agent.md` | `daily-work-update.md` (+ slack/jira/bitbucket/git skills, read-only) | `daily update`, `morning digest`, `yesterday work`, `#my-daily-work-update`, `/daily-work-update` |
