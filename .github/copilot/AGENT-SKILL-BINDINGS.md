...
|---------------------|-----------------------------------------------|
| `askai` | `askai-ephemeral-output.md`, `askai-skill-evolution.md`, `jira-workflow.md`, `git-sync.md`, `db-restore.md`, `bitbucket-unify-enterprise.md`, `slack-integration.md` |
